...
- **Data and warehousing:** SQL, Snowflake, Excel, relational data modeling
- **Analytics:** Python, Pandas, NumPy, Seaborn, Jupyter Notebook
- **Focus:** ETL, KPI design, analytical storytelling, and decision support
...
- Start with the business question and define what the output must support.
- Separate verified findings from assumptions and prototype results.
- Document data sources, limitations, and responsible-use considerations.
- Build toward reports that stakeholders can understand and review quickly.

## Currently

Building a focused portfolio for Data Analyst and BI Analyst opportunities.
